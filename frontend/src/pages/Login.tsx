      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative">
            <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border-2 border-cyan-500/30 flex items-center justify-center shadow-2xl shadow-cyan-500/20 backdrop-blur-sm overflow-hidden">
              <img 
                src="/Image/icon.png" 
          ...
          <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400 mt-6 mb-2">
            نظام أرشفة وتحليل البيانات
          </h1>
          <p className="text-text-secondary text-sm">مركز الاستشارات والتنمية</p>
        </div>

        {/* بطاقة تسجيل الدخول */}
        <div className="card relative backdrop-blur-xl bg-base-800/80 border-2 border-cyan-500/20 shadow-2xl shadow-cyan-500/10">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 rounded-xl blur opacity-50"></div>
          
          <div className="relative">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-cyan-400 mb-2">تسجيل الدخول</h2>
              <p className="text-text-secondary text-sm">أدخل بياناتك للوصول إلى حسابك</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-12 pr-4 py-3 rounded-xl bg-base-900/50 border-2 border-[rgba(0,188,212,0.15)] focus:border-cyan-500 focus:outline-none transition-all text-text-primary placeholder:text-text-secondary/50"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-12 pr-12 py-3 rounded-xl bg-base-900/50 border-2 border-[rgba(0,188,212,0.15)] focus:border-cyan-500 focus:outline-none transition-all text-text-primary placeholder:text-text-secondary/50"
                  ...
                  <button
                    ...
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-text-secondary hover:text-cyan-400 transition-colors"
                    disabled={loading}
                  >
                    {showPassword ? (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* نص إضافي في الأسفل */}
        <p className="text-center text-text-secondary/60 text-xs mt-6">
